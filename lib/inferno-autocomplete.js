...
import { enableFindDOMNod, findDOMNode } from 'inferno';
...
export default class Autocomplete extends React.Component {
      ...
      Enter (event) {
        if (instance.state.isOpen === false) {
          ...
          instance.setState({
            ...
            instance.refs.input.setSelectionRange(
              value.length,
              value.length
            )
  ...
  renderMenu () {
    ...
    var menu = (this.props.renderMenu || function renderMenu(items, value, style) {
      return React.createElement('div', { ...instance.props, style: _extends({}, style, instance.menuStyle), children: items });
